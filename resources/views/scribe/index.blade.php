    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentification">
                    <a href="#authentification">Authentification</a>
                                ...
                                <a href="#authentification-POSTapi-login">Connexion d’un utilisateur

Ce endpoint permet à un utilisateur de se connecter et de recevoir un token JWT.</a>
                            </li>
                                                                        </ul>
                            </ul>
...
Ce endpoint permet à un utilisateur de se connecter et de recevoir un token JWT.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>L’email de l’utilisateur. Example: <code>john@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Le mot de passe. Example: <code>secret123</code></p>
        </div>
        </form>
